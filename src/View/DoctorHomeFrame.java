...
public class DoctorHomeFrame extends JFrame{
	...
	/*-- Design --*/
	private ImageIcon logoImage = new ImageIcon(DoctorHomeFrame.class.getResource("/view/icons/logo.png"));
	private ImageIcon homeImage = new ImageIcon(DoctorHomeFrame.class.getResource("/view/icons/home.png"));
	private ImageIcon patientImage = new ImageIcon(DoctorHomeFrame.class.getResource("/view/icons/patient.png"));
	private ImageIcon rdvImage = new ImageIcon(DoctorHomeFrame.class.getResource("/view/icons/calendar.png"));
	private ImageIcon signOutImage = new ImageIcon(DoctorHomeFrame.class.getResource("/view/icons/signOut.png"));	
	...
	public DoctorHomeFrame() {
		...
		logoLabel.setBounds(50, 5, 400, 100);
	...
	public static void launch() {
		DoctorHomeFrame homeDoctorView = new DoctorHomeFrame();
