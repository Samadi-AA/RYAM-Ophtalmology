...
public class LoginView extends JFrame {
	...
	/*-- Design --*/
	private ImageIcon logoImage = new ImageIcon(LoginView.class.getResource("/view/icons/logo.png"));
	private ImageIcon passwordIcon = new ImageIcon(LoginView.class.getResource("/view/icons/pwdIcon.png"));
		...
		btnLogin.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent mev) {
				...
				if (username.equalsIgnoreCase("doctor") && password.equals(selectUserKey(username))) {
					LoginView.this.dispose(); //close the login window
					DoctorView.launch(); //launch the doctor's home window
				} 
				else if (username.equalsIgnoreCase("secretaire") && password.equals(selectUserKey(username))) {
					LoginView.this.dispose();
					SecretaireView.launch(); // launch the secretaire's home window
				} 
